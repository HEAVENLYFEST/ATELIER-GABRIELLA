...
export default function Contact() {
  ...
  const submit = async event => {
    ...
    const body = [
      ...
      `Lieu de l’événement : ${form.venue || 'Non renseigné'}`,
